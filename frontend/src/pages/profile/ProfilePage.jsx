					...
					{!isLoading && !isRefetching && user && (
						<>
							...
							<div className='flex w-full border-b border-gray-700 mt-4'>
								<div
									className='flex justify-center flex-1 p-3 hover:bg-gray-800 transition duration-300 relative cursor-pointer'
								...
								<div
									className='flex justify-center flex-1 p-3 text-slate-500 hover:bg-gray-800 transition duration-300 relative cursor-pointer'
